...
class Person private constructor(
    ...
    val publicKey: PublicKey
        get() = keyPair.public
            ?: error("Current Person implementation doesn't support functions that use the public key")
    private val privateKey: PrivateKey
        get() = keyPair.private
            ?: error("Current Person implementation doesn't support functions that use the private key")
...
//            println(string)
        ...
        fun deterministicFromString(string: String): Person =
            Person(buildKeyPair(DigestUtils.sha1(string)!!.contentHashCode().toLong()))
